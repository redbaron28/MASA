...
public class OrePopulator extends BlockPopulator{
    ...
    static class GENERATED_BLOCK {
        ...
        static ArrayList<GENERATED_BLOCK> fromConfig() {
            ...
            list.add("PACKED_ICE:15:1:50");
            list.add("ICE:10:1:50");
            list.add("IRON_ORE:12:1:50");
            list.add("REDSTONE_ORE:10:1:50");
            list.add("GOLD_ORE:10:1:50");
            list.add("DIAMOND_ORE:7:1:50");
            list.add("EMERALD_ORE:5:1:50");
            list.add("LAPIS_ORE:4:1:50");
