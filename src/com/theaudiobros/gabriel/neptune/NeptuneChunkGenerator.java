package com.theaudiobros.gabriel.neptune;
...
public class NeptuneChunkGenerator extends ChunkGenerator {
        ...
        for (int x = 0; x < 16; x++) {
            for (int z = 0; z < 16; z++) {
                ...
                for (int y = 0; y < maxHeight; y++) {
                    data.setBlock(x, y, z, Material.STAINED_CLAY.getId(), (byte) 3);
                }
            }
        }
    ...
    public List<BlockPopulator> getDefaultPopulators(World world) {
        ...
        pops.add(new com.theaudiobros.gabriel.neptune.OrePopulator(MASA.getInstance()));
        return pops;
    }
