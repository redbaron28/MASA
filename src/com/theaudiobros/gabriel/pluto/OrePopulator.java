...
public class OrePopulator extends BlockPopulator{
    ...
    static class GENERATED_BLOCK {
        ...
        static ArrayList<GENERATED_BLOCK> fromConfig() {
            ...
            list.add("PACKED_ICE:20:1:255");
            list.add("ICE:15:1:255");
            list.add("IRON_ORE:45:1:255");
            list.add("REDSTONE_ORE:30:1:255");
            list.add("GOLD_ORE:30:1:255");
            list.add("DIAMOND_ORE:25:1:255");
            list.add("EMERALD_ORE:20:1:255");
            list.add("LAPIS_ORE:12:1:255");
