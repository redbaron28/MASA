package com.theaudiobros.gabriel.mercury;
...
public class MercuryChunkGenerator extends ChunkGenerator {
        ...
        for (int x = 0; x < 16; x++) {
            for (int z = 0; z < 16; z++) {
                ...
                for (int y = 0; y < maxHeight; y++) {
                    data.setBlock(x, y, z, Material.CONCRETE.getId(), (byte) 7);
                }
            }
        }
    ...
    public List<BlockPopulator> getDefaultPopulators(World world) {
        ...
        pops.add(new com.theaudiobros.gabriel.mercury.OrePopulator(MASA.getInstance()));
        return pops;
    }
