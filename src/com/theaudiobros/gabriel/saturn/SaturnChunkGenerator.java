package com.theaudiobros.gabriel.saturn;
...
public class SaturnChunkGenerator extends ChunkGenerator {
        ...
        for (int x = 0; x < 16; x++) {
            for (int z = 0; z < 16; z++) {
                ...
                for (int y = 0; y < maxHeight; y++) {
                    data.setBlock(x, y, z, Material.ENDER_STONE.getId(), (byte) 0);
                }
            }
        }
    ...
    public List<BlockPopulator> getDefaultPopulators(World world) {
        ...
        pops.add(new com.theaudiobros.gabriel.saturn.OrePopulator(MASA.getInstance()));
        return pops;
    }
