package com.theaudiobros.gabriel.uranus;
...
public class OrePopulator extends BlockPopulator{
    ...
    public void populate(World world, Random random, Chunk chunk) {
        ...
        for (Location loc : ore.keySet()) {
            ...
            if (cb.getType() == Material.CONCRETE) {
    ...
    static class GENERATED_BLOCK {
        ...
        static ArrayList<GENERATED_BLOCK> fromConfig() {
            ...
            list.add("PACKED_ICE:15:1:30");
            list.add("ICE:10:1:30");
            list.add("WATER:5:1:30");
            list.add("IRON_ORE:30:1:5");
            list.add("REDSTONE_ORE:15:1:30");
            list.add("GOLD_ORE:18:1:25");
            list.add("DIAMOND_ORE:3:1:10");
            list.add("EMERALD_ORE:2:1:10");
            list.add("LAPIS_ORE:7:1:15");
