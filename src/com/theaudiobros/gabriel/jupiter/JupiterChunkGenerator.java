package com.theaudiobros.gabriel.jupiter;
...
public class JupiterChunkGenerator extends ChunkGenerator {
        ...
        for (int x = 0; x < 16; x++) {
            for (int z = 0; z < 16; z++) {
                ...
                for (int y = 0; y < maxHeight; y++) {
                    ...
                    if(a<9)
                        data.setBlock(x, y, z, Material.SANDSTONE.getId(), (byte) 0);
                    else
                        data.setBlock(x, y, z, Material.DIRT.getId(), (byte) 1);
                }
            }
        }
    ...
    public List<BlockPopulator> getDefaultPopulators(World world) {
        ...
        pops.add(new com.theaudiobros.gabriel.jupiter.OrePopulator(MASA.getInstance()));
        return pops;
    }
